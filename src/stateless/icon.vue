<template>
    <div class="icon-wrapper" @click="$emit('click', $event)" @keyup="$emit('keyup', $event)" @keydown="$emit('keydown', $event)">
        ...
        <svg v-if="name === 'pencil-edit'" :style="styleOverride" viewBox="0 0 23 26"
        ...
        <svg v-if="name === 'delete-icon'" :style="styleOverride"
        ...
        <svg v-if="name === 'duplicate-icon'" :style="styleOverride"
             viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="nonzero">
                <path class="path"
        ...
        <svg v-if="name === 'back'" :style="styleOverride" viewBox="0 0 8 17" xmlns="http://www.w3.org/2000/svg">
            <path class="path" d="M6.555 17L.23 9.157a1.058 1.058 0 0 1 0-1.314L6.555 0 8 1.316 2.204 8.5l5.795 7.183L6.555 17z"/>
        </svg>

        <!-- 'save': floppy icon  -->
        <svg v-if="name === 'save'" :style="styleOverride" viewBox="0 0 12 14" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'arrow-down-strong'" :style="styleOverride" viewBox="0 0 12 16" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g class="path">
                <polygon points="7 16 14 8 10 8 10 4 4 4 4 8 0 8"/>
                <rect x="4" width="6" height="2"/>
            </g>
        </svg>

        <!-- 'loading': loader spinning icon -->
        <svg v-if="name === 'loading'" :style="styleOverride" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <!-- 'funnel': funnel (filter) icon -->
        <svg v-if="name === 'funnel'" :style="styleOverride" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <path class="path" d="M15,0H1C0.4,0,0,0.4,0,1v2c0,0.3,0.1,0.6,0.4,0.8L6,8.5V15c0,0.4,0.2,0.8,0.6,0.9C6.7,16,6.9,16,7,16 c0.3,0,0.5-0.1,0.7-0.3l2-2C9.9,13.5,10,13.3,10,13V8.5l5.6-4.7C15.9,3.6,16,3.3,16,3V1C16,0.4,15.6,0,15,0z"></path>
        </svg>

        <svg v-if="name === 'remove'" :style="styleOverride" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <path class="path" d="M2 6v8c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V6H2zM12 3V1c0-.6-.4-1-1-1H5c-.6 0-1 .4-1 1v2H0v2h16V3h-4zm-2 0H6V2h4v1z"/>
        </svg>

        <svg v-if="name === 'plus'" :style="styleOverride" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <path class="path" d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm4 9H9v3H7V9H4V7h3V4h2v3h3v2z" fill-rule="nonzero"/>
        </svg>

        <svg v-if="name === 'plus-v2'" :style="styleOverride" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 0H6v6H0v4h6v6h4v-6h6V6h-6z" fill="#444450" fill-rule="nonzero"/>
        </svg>

        <svg v-if="name === 'left-arrow'" :style="styleOverride" viewBox="0 0 22 17" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'right-arrow'" :style="styleOverride" viewBox="0 0 22 17" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'search'" :style="styleOverride" viewBox="0 0 16 17" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'clear'" :style="styleOverride" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'x-bold'" :style="styleOverride" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg">
            <path class="path" d="M6.4 0L4 2.4 1.6 0 0 1.6 2.4 4 0 6.4 1.6 8 4 5.6 6.4 8 8 6.4 5.6 4 8 1.6z"/>
        </svg>

        <!-- 'close': X sign, thin -->
        <svg v-if="name === 'close'" :style="styleOverride" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- 'mail': envelope icon -->
        <svg v-if="name === 'mail'" :style="styleOverride" viewBox="0 0 16 14" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'screen-download'" :style="styleOverride" viewBox="0 0 16 15" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'card-edit'" :style="styleOverride" viewBox="0 0 16 15" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'chain-link'" :style="styleOverride" viewBox="0 0 18 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'clock'" :style="styleOverride" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'sort'" :style="styleOverride" viewBox="0 0 7 9" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'backward'" :style="styleOverride" viewBox="0 0 30 22" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="evenodd">
                <path class="stroke-path" stroke="#D6D8DD" stroke-width="2" fill="none" stroke-linecap="square" d="M11 20l-9-9 9-9"/>
            </g>
        </svg>

        <svg v-if="name === 'pencil-edit-line'" :style="styleOverride" viewBox="0 0 23 26" xmlns="http://www.w3.org/2000/svg">
            <path class="path" d="M18.451 20.996H3.91c-.545 0-.909-.364-.909-.91 0-.545.364-.908.909-.908H18.45c.545 0 .909.363.909.909 0 .545-.364.909-.909.909zM17.27 7.635l1.454-1.454a.879.879 0 0 0 0-1.273l-3.272-3.272a.879.879 0 0 0-1.273 0L12.725 3.09l4.545 4.545zM11.453 4.363l-7.271 7.271a.825.825 0 0 0-.273.636v3.272c0 .546.363.91.909.91H8.09c.272 0 .454-.092.636-.274l7.271-7.27-4.544-4.545z"/>
        </svg>

        <svg v-if="name === 'alpha'" :style="styleOverride" viewBox="0 0 300 92" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="name === 'beta'" :style="styleOverride" viewBox="0 0 300 114" xmlns="http://www.w3.org/2000/svg">
